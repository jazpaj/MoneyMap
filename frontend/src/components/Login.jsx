...
import { DollarSign, LogIn, AlertCircle, User, Lock } from 'lucide-react'
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(msg)
      triggerShake()
      if (msg.toLowerCase().includes('username') || msg.toLowerCase().includes('no account')) {
        setFieldErrors({ username: true })
    ...
    <div className="auth-page">
      <div className={`auth-card ${shake ? 'auth-shake' : ''}`}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1>Welcome back</h1>
          <p className="subtitle">Sign in to your finance tracker</p>
        </div>
          ...
          <div className="form-group">
            ...
            <div className={`input-icon-wrap ${fieldErrors.username ? 'input-error-wrap' : ''}`}>
              ...
              <input
                ...
                value={form.username}
                onChange={(e) => { setForm({ ...form, username: e.target.value }); setFieldErrors({}); setError('') }}
          ...
          <div className="form-group">
            ...
            <div className={`input-icon-wrap ${fieldErrors.password ? 'input-error-wrap' : ''}`}>
              ...
              <input
                ...
                type="password"
                value={form.password}
                onChange={(e) => { setForm({ ...form, password: e.target.value }); setFieldErrors({}); setError('') }}
